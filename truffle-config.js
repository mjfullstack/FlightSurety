...
const infuraKey = "3ac14fbe81e0423fa4bd9936e05fa011" // FlightSurety Project 7
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => { return new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/${infuraKey}`, 0, 50) },
